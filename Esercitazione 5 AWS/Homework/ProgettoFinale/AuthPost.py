#This is the authrization for the post
import json
...
def lambda_handler(event, context):
    ...
    authResponse = { "principalId": "abc123", "policyDocument": { "Version": "2012-10-17", "Statement": [{"Action": "execute-api:Invoke", "Resource": ["arn:aws:execute-api:us-east-1:807692992940:bq2ldpeny6/*/*"], "Effect": auth}] }}
    return authResponse
